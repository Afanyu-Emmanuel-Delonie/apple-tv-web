    ...
    <section className="relative py-16 overflow-hidden bg-[#f0f4ff]">
      ...
      <div className="absolute inset-0 flex items-center justify-end pointer-events-none overflow-hidden">
        ...
        >
          ...
          {/* Network lines */}
          <g stroke="#ff0800" strokeWidth="1.5">
          ...
          {nodes.map(({ cx, cy, dur, initials }) => (
            <g key={initials}>
              ...
              <circle cx={cx} cy={cy} r="16" fill="#111827" stroke="#ff0800" strokeWidth="1.5" />
              <text x={cx} y={cy + 4} textAnchor="middle" fontSize="8" fontWeight="600" fill="#ff0800" fontFamily="DM Sans, sans-serif" letterSpacing="0.5">
                {initials}
              </text>
            </g>
          ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-[540px]">
            ...
            <div className="flex items-center gap-2 mb-5">
              ...
              <span className="text-[11px] font-medium tracking-[0.12em] uppercase text-[#002fa7]/60">
                Exclusive Access
              </span>
            </div>
            ...
            >
              ...
              for{" "}
              <span className="text-[#002fa7] italic">Exclusive</span>{" "}
              Opportunities
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-14">
              <button
                type="button"
                className="inline-flex items-center gap-2.5 px-8 py-4 bg-[#002fa7] text-white text-[13px] font-semibold tracking-[0.06em] uppercase rounded cursor-pointer transition-all duration-200 hover:bg-[#0028a0] hover:-translate-y-0.5 active:scale-95"
              ...
              <button
                type="button"
                className="inline-flex items-center gap-2 px-8 py-4 bg-white border-2 border-[#e3e6ee] text-[#002fa7] text-[13px] font-medium tracking-[0.06em] uppercase rounded cursor-pointer transition-all duration-200 hover:bg-[#002fa7] hover:text-white hover:border-[#002fa7]"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              >
                See More
          ...
          <div className="hidden lg:flex flex-col gap-4 items-start pl-8">
            ...
            <div className="bg-white border border-[#e3e6ee] rounded-2xl px-6 py-5 w-full max-w-[380px] shadow-sm">
              ...
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2.5">
                  ...
                  <div className="w-8 h-8 rounded-full border-2 border-[#f0f4ff] bg-[#002fa7] flex items-center justify-center" style={{ zIndex: 0 }}>
            ...
            <div className="bg-white border border-[#e3e6ee] rounded-2xl px-6 py-5 w-full max-w-[380px] shadow-sm">
              ...
              <div className="flex flex-col gap-3">
                {updates.map(({ ini, msg, time }, i) => (
                  <div key={ini} className="flex items-start gap-3">
                    <img
                      src={`https://randomuser.me/api/portraits/${i % 2 === 0 ? 'men' : 'women'}/${60 + i}.jpg`}
                      alt="User"
                      className="w-7 h-7 rounded-full border border-[#002fa7]/30 flex-shrink-0 mt-0.5 object-cover"
                    />
            ...
            <div className="grid grid-cols-2 gap-3 w-full max-w-[380px]">
              {[
                ...
                <div key={label} className="bg-white border border-[#e3e6ee] rounded-xl px-4 py-4 shadow-sm">
                  <p
                    className="text-[20px] font-black text-[#002fa7] leading-none mb-1"
                    style={{ fontFamily: "'Playfair Display', serif" }}
                  >
                    {val}
                  </p>
