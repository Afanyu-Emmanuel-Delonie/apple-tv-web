...
export default function Opportunities() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Header */}
      <div className="bg-gradient-to-br from-[#047857] to-[#059669] py-16">
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-[32px] font-playfair font-black text-[#0b1020]">Featured Opportunities</h2>
              ...
              <article key={opportunity.id} className="bg-white rounded-lg overflow-hidden border border-[#e3e6ee] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-300 group h-full">
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3 flex gap-2">
                    ...
                    <span className="px-3 py-1 text-[10px] font-bold tracking-[0.1em] uppercase text-white rounded bg-[#0b1020]">
                      {opportunity.type}
                    </span>
                  </div>
                </div>
                <div className="p-5">
                  ...
                  <div className="space-y-2 pt-3 border-t border-[#e3e6ee]">
                    <div className="flex items-center justify-between text-[12px]">
                      <span className="text-[#8b91a5]">{opportunity.location}</span>
                      <span className="font-bold text-[#002fa7]">{opportunity.salary}</span>
                    </div>
                    <div className="flex items-center justify-between text-[12px]">
                      <span className="text-[#8b91a5]">Deadline: {opportunity.deadline}</span>
                    </div>
                  </div>
                </div>
              </article>
        ...
        <div className="bg-white border border-[#e3e6ee] rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-[16px] font-bold text-[#0b1020] mb-2">Tailor Your Resume</h3>
              <p className="text-[13px] text-[#5a6073]">Customize your CV for each application to highlight relevant skills and experience.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[#002fa7]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <div className="w-8 h-8 rounded-full bg-[#002fa7]" />
              </div>
              <h3 className="text-[16px] font-bold text-[#0b1020] mb-2">Research the Company</h3>
              <p className="text-[13px] text-[#5a6073]">Learn about the organization's mission, values, and recent achievements before applying.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[#002fa7]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <div className="w-8 h-8 rounded-full bg-[#002fa7]" />
              </div>
              <h3 className="text-[16px] font-bold text-[#0b1020] mb-2">Follow Up</h3>
              <p className="text-[13px] text-[#5a6073]">Send a polite follow-up email if you haven't heard back within the stated timeframe.</p>
            </div>
          </div>
        </div>
      </div>
