...
export default function InternationalNews() {
  ...
  // SEO for International News page
  useSEO({
    title: 'International News - Global Coverage',
    description: 'Stay informed with comprehensive coverage of global events, international politics, world economy, and stories that impact Cameroon and the diaspora.',
    keywords: 'international news, global news, world politics, international affairs, global economy, world events, Cameroon international news, Apple Fam TV',
  ...
  const fetchInternationalNews = async () => {
    try {
      ...
      console.log('Fetched international articles:', data);
      setArticles(data);
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-br from-[#002fa7] to-[#001f73] py-16">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <h1 className="text-[clamp(28px,6vw,56px)] font-playfair font-black text-white leading-[1.05] mb-4">
            International <span className="italic">News</span>
          </h1>
          <p className="text-[16px] text-white/80 max-w-[700px] leading-relaxed">
            Stay informed with comprehensive coverage of global events, international politics, world economy, and stories that impact Cameroon and the diaspora.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-12">
        ...
        {loading ? (
          <div className="text-center py-20">
            ...
            <p className="text-[14px] text-[#5a6073]">Loading international news...</p>
          </div>
        ) : articles.length === 0 ? (
          <div className="text-center py-20">
            <p className="text-[18px] text-[#5a6073]">No international news available at the moment.</p>
          </div>
        ) : (
          <>
            {/* Featured Stories */}
            <div className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-[32px] font-playfair font-black text-[#0b1020]">Featured Stories</h2>
                <span className="text-[12px] font-semibold tracking-[0.12em] uppercase text-[#8b91a5]">Breaking</span>
              </div>
                      ...
                      <div className="relative h-64 rounded-lg overflow-hidden mb-4">
                        ...
                        <div className="absolute bottom-4 left-4 right-4">
                          <h3 className="text-[20px] font-playfair font-black text-white leading-[1.2] group-hover:text-[#ffd700] transition-colors">
                            {formatHeadline(article.title, 'featured')}
                          </h3>
                        </div>
                      </div>
                    </div>
            ...
            <div className="mb-6">
              <p className="text-[14px] text-[#2c3348]/60">
                Showing <span className="font-semibold text-[#002fa7]">{startIndex + 1}-{Math.min(endIndex, articles.length)}</span> of <span className="font-semibold text-[#002fa7]">{articles.length}</span> international stories
              </p>
            </div>
                  ...
                  <article className="bg-white rounded-lg overflow-hidden border border-[#e3e6ee] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-300 group h-full">
                    ...
                    <div className="p-5">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-[11px] font-medium text-[#2c3348]">{formatAuthor(article.author)}</span>
                      </div>
                      ...
                      <p className="text-[14px] text-[#2c3348]/70 leading-[1.6]">
                        {formatExcerpt(article.excerpt, 'card')}
                      </p>
                    </div>
                  </article>
                </Link>
      ...
      <OpportunitiesCTA
        ...
        headline="Never Miss Global "
        highlightText="Updates"
        description="Get instant notifications about breaking international news, global politics, and world events that matter to you and the Cameroon community."
