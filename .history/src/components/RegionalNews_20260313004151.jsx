...
export default function RegionalNews() {
  ...
  const regionColor =
    regions.find((r) => r.name === featuredStory.region)?.color || "#002fa7";
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="mb-10">
          ...
          <div className="flex items-end justify-between gap-4">
            ...
            <Link
              to="/regional-news"
              className="hidden md:inline-flex items-center gap-2 px-6 py-3 bg-[#002fa7] text-white text-[13px] font-semibold tracking-[0.06em] uppercase rounded cursor-pointer transition-all duration-200 hover:bg-[#0026c4] no-underline"
        ...
        {/* Featured Story */}
        <Link to="/regional-news" className="no-underline">
        ...
        <div className="flex justify-center mt-8 md:hidden">
          <Link
            to="/regional-news"
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#002fa7] text-white text-[13px] font-semibold tracking-[0.06em] uppercase rounded cursor-pointer transition-all duration-200 hover:bg-[#0026c4] no-underline"
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
            View All Regions
            <svg className="w-4 h-4" viewBox="0 0 16 16" fill="none">
