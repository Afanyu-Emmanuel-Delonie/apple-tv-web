  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-[32px] font-playfair font-black text-[#0b1020] mb-2">Opportunities</h1>
          <p className="text-[14px] text-[#5a6073]">Manage jobs, internships, and opportunities</p>
        </div>
        <button 
          onClick={handleAdd}
