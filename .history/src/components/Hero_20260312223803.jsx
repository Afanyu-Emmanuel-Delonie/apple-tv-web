...
export default function Hero() {
  ...
  return (
    <div className="relative w-screen h-[500px] md:h-[600px] overflow-hidden -mx-[50vw] left-1/2 right-1/2">
      {heroSlides.map((slide, index) => (
        ...
        >
          ...
          <div className="relative h-full max-w-[1200px] mx-auto px-6 flex flex-col justify-end pb-16 md:pb-20">
