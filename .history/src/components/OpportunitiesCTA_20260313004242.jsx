        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-[540px]">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-14">
              ...
              <button
                type="button"
                className="inline-flex items-center gap-2 px-8 py-4 bg-white border-2 border-[#e3e6ee] text-[#002fa7] text-[13px] font-medium tracking-[0.06em] uppercase rounded-full cursor-pointer transition-all duration-200 hover:bg-[#002fa7] hover:text-white hover:border-[#002fa7]"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              >
                See More
