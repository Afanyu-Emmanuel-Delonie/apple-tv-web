  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-50">
        ...
        {/* Gradient accent bar */}
        <div className="accent-bar h-[3px]" />
        ...
        <nav className="bg-white border-b border-[#e3e6ee] shadow-[0_1px_20px_rgba(11,16,32,0.06)]">
          <div className="max-w-[1200px] mx-auto px-6 flex items-stretch h-16">
            ...
            {/* Desktop nav links */}
            <ul className="hidden md:flex items-stretch list-none flex-1">
              {mainNav.map((item) => (
            ...
            <div className="hidden md:flex items-center gap-2.5 pl-4 border-l border-[#e3e6ee] ml-auto flex-shrink-0">
              {/* Live badge */}
              <div className="flex items-center gap-1.5 px-2.5 py-1 bg-[#ff0800]/[0.08] border border-[#ff0800]/20 rounded-full text-[11px] font-bold text-[#ff0800] tracking-[0.08em] uppercase cursor-pointer">
                <div className="live-dot w-1.5 h-1.5 rounded-full bg-[#ff0800]" />
                Live
              </div>
              <button
                type="button"
