      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-[520px]">
            ...
            {/* Headline */}
            <h2
              className="text-[clamp(38px,4.5vw,56px)] font-black text-white leading-[1.05] mb-6"
            ...
            {/* Description */}
            <p className="text-[16px] font-normal text-white/60 leading-[1.7] mb-8 max-w-[440px]">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <button
                type="button"
                className="inline-flex items-center gap-3 px-9 py-[18px] bg-[#ff0800] text-white text-[15px] font-semibold rounded cursor-pointer transition-all duration-200 hover:bg-[#c80600] hover:shadow-[0_8px_24px_rgba(255,8,0,0.3)] hover:-translate-y-0.5 active:scale-95"
          ...
          <div className="hidden lg:flex flex-col gap-4 items-start pl-8">
            ...
            {/* Members counter */}
            <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl px-6 py-5 w-full max-w-[380px]">
            ...
            <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl px-6 py-5 w-full max-w-[380px]">
              ...
              <div className="flex flex-col gap-3">
                {[
                  { img: "https://randomuser.me/api/portraits/men/22.jpg", msg: "Breaking: Markets hit record high today", time: "2m ago" },
                  { img: "https://randomuser.me/api/portraits/women/65.jpg", msg: "Tech giants report Q2 earnings results", time: "18m ago" },
                  { img: "https://randomuser.me/api/portraits/men/54.jpg", msg: "Climate summit reaches new agreement", time: "1h ago" },
                ].map(({ img, msg, time }, i) => (
                  <div key={i} className="flex items-start gap-3">
                    <img
                      src={img}
                      alt="User"
                      className="w-7 h-7 rounded-full border border-[#ff0800]/30 flex-shrink-0 mt-0.5 object-cover"
                    />
            ...
            <div className="grid grid-cols-2 gap-3 w-full max-w-[380px]">
              {[
                ...
                <div key={label} className="bg-white/[0.04] border border-white/[0.08] rounded-xl px-4 py-4">
                  <p
                    className="text-[20px] font-black text-white leading-none mb-1"
                    style={{ fontFamily: "'Playfair Display', serif" }}
                  >
                    {val}
                  </p>
