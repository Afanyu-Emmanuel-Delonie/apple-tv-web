      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="mb-10">
          ...
          <div className="flex items-end justify-between gap-4">
            ...
            <button
            name="view-more-regional-news"
              type="button"
              className="flex sm:hidden items-center gap-1.5 px-4 py-2 bg-[#002fa7] text-white text-[12px] font-semibold tracking-[0.06em] uppercase rounded cursor-pointer border-none transition-all duration-150 whitespace-nowrap hover:bg-[#0026c4] hover:-translate-y-px active:translate-y-0"
