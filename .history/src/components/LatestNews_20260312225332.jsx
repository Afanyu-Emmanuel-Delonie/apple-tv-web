    ...
    <section className="max-w-[1200px] mx-auto px-6 py-16">
      ...
      {hasMore && (
        <div className="flex justify-center mt-12">
          <button
            type="button"
            className="px-8 py-3 bg-transparent text-[13px] font-semibold tracking-[0.06em] uppercase rounded cursor-pointer transition-all duration-200 border-2"
            style={{ 
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = activeCategoryColor;
              e.currentTarget.style.color = "white";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.backgroundColor = "transparent";
              e.currentTarget.style.color = activeCategoryColor;
            }}
          >
            Load More Stories
          </button>
