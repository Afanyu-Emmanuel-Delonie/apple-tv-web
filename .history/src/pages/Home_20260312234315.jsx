    ...
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative py-24 overflow-hidden bg-[#0f0f0f]">
        ...
        <div className="absolute inset-0 flex items-center justify-end pointer-events-none overflow-hidden">
          <svg className="opacity-[0.25] w-[900px] h-auto flex-shrink-0 mr-[-80px]" viewBox="0 0 900 480" xmlns="http://www.w3.org/2000/svg">
            <defs>
            ...
            {/* Network Connections */}
            <g stroke="#ff0800" strokeWidth="1" opacity="0.3">
              <line x1="650" y1="80" x2="720" y2="120">
              ...
              <line x1="650" y1="80" x2="580" y2="140">
                <animate attributeName="opacity" values="0.1;0.5;0.1" dur="2.8s" repeatCount="indefinite" />
              </line>
              <line x1="580" y1="140" x2="720" y2="120">
                <animate attributeName="opacity" values="0.1;0.5;0.1" dur="4s" repeatCount="indefinite" />
              </line>
              <line x1="580" y1="140" x2="640" y2="220">
                <animate attributeName="opacity" values="0.1;0.5;0.1" dur="3.2s" repeatCount="indefinite" />
              </line>
              <line x1="640" y1="220" x2="780" y2="180">
                <animate attributeName="opacity" values="0.1;0.5;0.1" dur="2.5s" repeatCount="indefinite" />
              </line>
              <line x1="640" y1="220" x2="700" y2="290">
                <animate attributeName="opacity" values="0.1;0.5;0.1" dur="3.8s" repeatCount="indefinite" />
              </line>
              <line x1="700" y1="290" x2="780" y2="340">
                <animate attributeName="opacity" values="0.1;0.5;0.1" dur="2.9s" repeatCount="indefinite" />
              </line>
              <line x1="780" y1="180" x2="700" y2="290">
                <animate attributeName="opacity" values="0.1;0.5;0.1" dur="3.6s" repeatCount="indefinite" />
              </line>
            ...
            {/* Profile Nodes */}
            <g>
              <circle cx="650" cy="80" r="16" fill="#0f0f0f" stroke="#ff0800" strokeWidth="2">
                <animate attributeName="r" values="16;18;16" dur="2s" repeatCount="indefinite" />
              </circle>
              <circle cx="650" cy="80" r="6" fill="#ff0800">
                <animate attributeName="opacity" values="1;0.5;1" dur="2s" repeatCount="indefinite" />
              </circle>
              
              <circle cx="720" cy="120" r="16" fill="#0f0f0f" stroke="#ff0800" strokeWidth="2">
                <animate attributeName="r" values="16;18;16" dur="2.3s" repeatCount="indefinite" />
              </circle>
              <circle cx="720" cy="120" r="6" fill="#ff0800">
                <animate attributeName="opacity" values="1;0.5;1" dur="2.3s" repeatCount="indefinite" />
              </circle>
              
              <circle cx="580" cy="140" r="16" fill="#0f0f0f" stroke="#ff0800" strokeWidth="2">
                <animate attributeName="r" values="16;18;16" dur="2.7s" repeatCount="indefinite" />
              </circle>
              <circle cx="580" cy="140" r="6" fill="#ff0800">
                <animate attributeName="opacity" values="1;0.5;1" dur="2.7s" repeatCount="indefinite" />
              </circle>
              
              <circle cx="780" cy="180" r="16" fill="#0f0f0f" stroke="#ff0800" strokeWidth="2">
                <animate attributeName="r" values="16;18;16" dur="3.1s" repeatCount="indefinite" />
              </circle>
              <circle cx="780" cy="180" r="6" fill="#ff0800">
                <animate attributeName="opacity" values="1;0.5;1" dur="3.1s" repeatCount="indefinite" />
              </circle>
              
              <circle cx="640" cy="220" r="16" fill="#0f0f0f" stroke="#ff0800" strokeWidth="2">
                <animate attributeName="r" values="16;18;16" dur="2.5s" repeatCount="indefinite" />
              </circle>
              <circle cx="640" cy="220" r="6" fill="#ff0800">
                <animate attributeName="opacity" values="1;0.5;1" dur="2.5s" repeatCount="indefinite" />
              </circle>
              
              <circle cx="700" cy="290" r="16" fill="#0f0f0f" stroke="#ff0800" strokeWidth="2">
                <animate attributeName="r" values="16;18;16" dur="2.9s" repeatCount="indefinite" />
              </circle>
              <circle cx="700" cy="290" r="6" fill="#ff0800">
                <animate attributeName="opacity" values="1;0.5;1" dur="2.9s" repeatCount="indefinite" />
              </circle>
              
              <circle cx="780" cy="340" r="16" fill="#0f0f0f" stroke="#ff0800" strokeWidth="2">
                <animate attributeName="r" values="16;18;16" dur="3.3s" repeatCount="indefinite" />
              </circle>
              <circle cx="780" cy="340" r="6" fill="#ff0800">
                <animate attributeName="opacity" values="1;0.5;1" dur="3.3s" repeatCount="indefinite" />
              </circle>
              
              <circle cx="520" cy="200" r="16" fill="#0f0f0f" stroke="#ff0800" strokeWidth="2">
                <animate attributeName="r" values="16;18;16" dur="2.6s" repeatCount="indefinite" />
              </circle>
              <circle cx="520" cy="200" r="6" fill="#ff0800">
                <animate attributeName="opacity" values="1;0.5;1" dur="2.6s" repeatCount="indefinite" />
              </circle>
              
              <circle cx="820" cy="240" r="16" fill="#0f0f0f" stroke="#ff0800" strokeWidth="2">
                <animate attributeName="r" values="16;18;16" dur="3.4s" repeatCount="indefinite" />
              </circle>
              <circle cx="820" cy="240" r="6" fill="#ff0800">
                <animate attributeName="opacity" values="1;0.5;1" dur="3.4s" repeatCount="indefinite" />
              </circle>
              
              <circle cx="600" cy="360" r="16" fill="#0f0f0f" stroke="#ff0800" strokeWidth="2">
                <animate attributeName="r" values="16;18;16" dur="2.8s" repeatCount="indefinite" />
              </circle>
              <circle cx="600" cy="360" r="6" fill="#ff0800">
