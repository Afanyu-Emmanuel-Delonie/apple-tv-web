      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="mb-10">
          ...
          <div className="flex items-end justify-between gap-4">
            ...
            <Link
            to="/regional-news"
            className="inline-flex sm-none items-center gap-2 px-6 py-3 bg-[#002fa7] text-white text-[13px] font-semibold tracking-[0.06em] uppercase rounded cursor-pointer transition-all duration-200 hover:bg-[#ff0800] no-underline"
