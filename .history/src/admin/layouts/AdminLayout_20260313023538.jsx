        ...
        >
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <Link
              to="/"
              target="_blank"
              className="hidden sm:flex items-center gap-2 px-4 py-2 text-[13px] font-semibold text-[#002fa7] border border-[#002fa7] rounded hover:bg-[#002fa7] hover:text-white transition-colors no-underline"
            >
